...
Key | Value
------------ | ------------
apiKey | YAuqqHytljloAQEBxwHYqna4yJuStzqAMGzOcbpeKGZL9dMONQD5JH88LVrqhpYU
secretKey | 52ZY3kxAZZsCC8iNBwrjCfcVguObEICN2MAxwG6EKaBRnz8jhZHsmlzgddrJdmDX
...
```shell
[linux]$ echo -n "symbol=ETHBTC&side=BUY&type=LIMIT&timeInForce=GTC&quantity=1&price=0.1&recvWindow=5000&timestamp=1538323200000" | openssl dgst -sha256 -hmac "52ZY3kxAZZsCC8iNBwrjCfcVguObEICN2MAxwG6EKaBRnz8jhZHsmlzgddrJdmDX"
...
```shell
[linux]$ echo -n "symbol=ETHBTC&side=BUY&type=LIMIT&timeInForce=GTCquantity=1&price=0.1&recvWindow=5000&timestamp=1538323200000" | openssl dgst -sha256 -hmac "52ZY3kxAZZsCC8iNBwrjCfcVguObEICN2MAxwG6EKaBRnz8jhZHsmlzgddrJdmDX"
